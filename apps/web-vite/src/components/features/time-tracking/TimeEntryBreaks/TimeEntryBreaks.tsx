            ...
            <div className="animate-field-in space-y-4" style={{ "--field-delay": "40ms" } as React.CSSProperties}>
              <div>
                ...
                <div className="inline-flex w-fit px-3 py-2.5 rounded-xl border border-neutral-200/80 dark:border-neutral-700/70 bg-gradient-to-b from-white to-neutral-50/80 dark:from-neutral-900 dark:to-neutral-900/80 text-neutral-900 dark:text-neutral-100 items-center gap-1.5 shadow-soft hover:shadow-soft-md focus-within:border-primary-500/70 dark:focus-within:border-primary-400/70 focus-within:shadow-[0_0_0_3px_rgba(59,130,246,0.15)] transition-all duration-200">
                  ...
                  <input id="startedAtDay" name="startedAtDay" type="text" defaultValue={addBreakDefaults.startDay || "01"} required inputMode="numeric" placeholder="TT" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 1, 31)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                  <span className="text-neutral-400 dark:text-neutral-500 text-sm">.</span>
                  <input id="startedAtMonth" name="startedAtMonth" type="text" defaultValue={addBreakDefaults.startMonth || "01"} required inputMode="numeric" placeholder="MM" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 1, 12)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                  <span className="text-neutral-400 dark:text-neutral-500 text-sm">.</span>
                  <input id="startedAtYear" name="startedAtYear" type="text" defaultValue={addBreakDefaults.startYear || String(new Date().getFullYear())} required inputMode="numeric" placeholder="JJJJ" pattern="\\d{4}" onKeyDown={(e) => handleNumericArrowKey(e, 1970, 9999, 4)} className="w-12 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                  ...
                  <input id="startedAtHour" name="startedAtHour" type="text" defaultValue={addBreakDefaults.startHour || "12"} required inputMode="numeric" placeholder="HH" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 0, 23)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                  <span className="text-neutral-400 dark:text-neutral-500 text-sm">:</span>
                  <input id="startedAtMinute" name="startedAtMinute" type="text" defaultValue={addBreakDefaults.startMinute || "00"} required inputMode="numeric" placeholder="MM" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 0, 59)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1.5">
                ...
                <div className="inline-flex w-fit px-3 py-2.5 rounded-xl border border-neutral-200/80 dark:border-neutral-700/70 bg-gradient-to-b from-white to-neutral-50/80 dark:from-neutral-900 dark:to-neutral-900/80 text-neutral-900 dark:text-neutral-100 items-center gap-1.5 shadow-soft hover:shadow-soft-md focus-within:border-primary-500/70 dark:focus-within:border-primary-400/70 focus-within:shadow-[0_0_0_3px_rgba(59,130,246,0.15)] transition-all duration-200">
                  <span className="text-[10px] font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400 mr-1">Date</span>
                  <input id="endedAtDay" name="endedAtDay" type="text" defaultValue={addBreakDefaults.endDay || "01"} required inputMode="numeric" placeholder="TT" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 1, 31)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                  <span className="text-neutral-400 dark:text-neutral-500 text-sm">.</span>
                  <input id="endedAtMonth" name="endedAtMonth" type="text" defaultValue={addBreakDefaults.endMonth || "01"} required inputMode="numeric" placeholder="MM" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 1, 12)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                  <span className="text-neutral-400 dark:text-neutral-500 text-sm">.</span>
                  <input id="endedAtYear" name="endedAtYear" type="text" defaultValue={addBreakDefaults.endYear || String(new Date().getFullYear())} required inputMode="numeric" placeholder="JJJJ" pattern="\\d{4}" onKeyDown={(e) => handleNumericArrowKey(e, 1970, 9999, 4)} className="w-12 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                  <span className="mx-1 h-5 w-px bg-neutral-300 dark:bg-neutral-600" />
                  <span className="text-[10px] font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400 ml-0.5 mr-0.5">Time</span>
                  <input id="endedAtHour" name="endedAtHour" type="text" defaultValue={addBreakDefaults.endHour || "12"} required inputMode="numeric" placeholder="HH" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 0, 23)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                  <span className="text-neutral-400 dark:text-neutral-500 text-sm">:</span>
                  <input id="endedAtMinute" name="endedAtMinute" type="text" defaultValue={addBreakDefaults.endMinute || "30"} required inputMode="numeric" placeholder="MM" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 0, 59)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleUpdateBreak} className="space-y-4">
              <div className="animate-field-in space-y-4" style={{ "--field-delay": "40ms" } as React.CSSProperties}>
                <div>
                  ...
                  <div className="inline-flex w-fit px-3 py-2.5 rounded-xl border border-neutral-200/80 dark:border-neutral-700/70 bg-gradient-to-b from-white to-neutral-50/80 dark:from-neutral-900 dark:to-neutral-900/80 text-neutral-900 dark:text-neutral-100 items-center gap-1.5 shadow-soft hover:shadow-soft-md focus-within:border-primary-500/70 dark:focus-within:border-primary-400/70 focus-within:shadow-[0_0_0_3px_rgba(59,130,246,0.15)] transition-all duration-200">
                    <span className="text-[10px] font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400 mr-1">Date</span>
                    <input id="edit-startedAtDay" name="startedAtDay" type="text" defaultValue={toDateParts(editingBreak.startedAt).day} required inputMode="numeric" placeholder="TT" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 1, 31)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                    <span className="text-neutral-400 dark:text-neutral-500 text-sm">.</span>
                    <input id="edit-startedAtMonth" name="startedAtMonth" type="text" defaultValue={toDateParts(editingBreak.startedAt).month} required inputMode="numeric" placeholder="MM" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 1, 12)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                    <span className="text-neutral-400 dark:text-neutral-500 text-sm">.</span>
                    <input id="edit-startedAtYear" name="startedAtYear" type="text" defaultValue={toDateParts(editingBreak.startedAt).year} required inputMode="numeric" placeholder="JJJJ" pattern="\\d{4}" onKeyDown={(e) => handleNumericArrowKey(e, 1970, 9999, 4)} className="w-12 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                    <span className="mx-1 h-5 w-px bg-neutral-300 dark:bg-neutral-600" />
                    <span className="text-[10px] font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400 ml-0.5 mr-0.5">Time</span>
                    <input id="edit-startedAtHour" name="startedAtHour" type="text" defaultValue={toTimePart(editingBreak.startedAt).split(":")[0]} required inputMode="numeric" placeholder="HH" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 0, 23)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                    <span className="text-neutral-400 dark:text-neutral-500 text-sm">:</span>
                    <input id="edit-startedAtMinute" name="startedAtMinute" type="text" defaultValue={toTimePart(editingBreak.startedAt).split(":")[1]} required inputMode="numeric" placeholder="MM" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 0, 59)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1.5">
                  ...
                  <div className="inline-flex w-fit px-3 py-2.5 rounded-xl border border-neutral-200/80 dark:border-neutral-700/70 bg-gradient-to-b from-white to-neutral-50/80 dark:from-neutral-900 dark:to-neutral-900/80 text-neutral-900 dark:text-neutral-100 items-center gap-1.5 shadow-soft hover:shadow-soft-md focus-within:border-primary-500/70 dark:focus-within:border-primary-400/70 focus-within:shadow-[0_0_0_3px_rgba(59,130,246,0.15)] transition-all duration-200">
                    <span className="text-[10px] font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400 mr-1">Date</span>
                    <input id="edit-endedAtDay" name="endedAtDay" type="text" defaultValue={editingBreak.endedAt ? toDateParts(editingBreak.endedAt).day : ""} inputMode="numeric" placeholder="TT" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 1, 31)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                    <span className="text-neutral-400 dark:text-neutral-500 text-sm">.</span>
                    <input id="edit-endedAtMonth" name="endedAtMonth" type="text" defaultValue={editingBreak.endedAt ? toDateParts(editingBreak.endedAt).month : ""} inputMode="numeric" placeholder="MM" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 1, 12)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                    <span className="text-neutral-400 dark:text-neutral-500 text-sm">.</span>
                    <input id="edit-endedAtYear" name="endedAtYear" type="text" defaultValue={editingBreak.endedAt ? toDateParts(editingBreak.endedAt).year : ""} inputMode="numeric" placeholder="JJJJ" pattern="\\d{4}" onKeyDown={(e) => handleNumericArrowKey(e, 1970, 9999, 4)} className="w-12 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                    <span className="mx-1 h-5 w-px bg-neutral-300 dark:bg-neutral-600" />
                    <span className="text-[10px] font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400 ml-0.5 mr-0.5">Time</span>
                    <input id="edit-endedAtHour" name="endedAtHour" type="text" defaultValue={editingBreak.endedAt ? toTimePart(editingBreak.endedAt).split(":")[0] : ""} inputMode="numeric" placeholder="HH" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 0, 23)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                    <span className="text-neutral-400 dark:text-neutral-500 text-sm">:</span>
                    <input id="edit-endedAtMinute" name="endedAtMinute" type="text" defaultValue={editingBreak.endedAt ? toTimePart(editingBreak.endedAt).split(":")[1] : ""} inputMode="numeric" placeholder="MM" pattern="\\d{2}" onKeyDown={(e) => handleNumericArrowKey(e, 0, 59)} className="w-7 bg-transparent text-center text-sm text-neutral-900 dark:text-neutral-100 focus:outline-none" />
                  </div>
