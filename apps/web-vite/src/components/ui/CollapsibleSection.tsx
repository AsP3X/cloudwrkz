...
export const CollapsibleSection = ({
  ...
  return (
    <div
      className={cn(
        "bg-white dark:bg-neutral-900 rounded-xl shadow-soft-lg border border-neutral-200 dark:border-neutral-800 p-6 sm:p-8",
        className
      )}
    >
      {/* Header with toggle */}
      ...
      >
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex-shrink-0">
            <svg
              className={cn(
                "w-5 h-5 text-neutral-500 dark:text-neutral-400 transition-transform duration-200",
