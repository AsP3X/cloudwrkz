...
export function OfflineWarning() {
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: isDark ? "rgba(113, 63, 18, 0.9)" : "rgb(253 230 138)",
        width: "100%",
        display: "block",
      }}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-yellow-900 dark:text-yellow-100">You are currently offline</p>
