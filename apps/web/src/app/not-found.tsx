...
/**
 * Cloud SVG component used in the floating animation.
 * Each cloud has a slightly different shape for visual variety.
 */
...
/**
 * A small confused-face cloud — the "lost" cloud — that bobs gently.
 */
...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-primary-50 via-white to-secondary-50 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950 relative overflow-hidden">
      {/* ---------- Background decoration (matches rest of app) ---------- */}
      ...
      {/* ---------- Floating clouds — many, distributed across the page (gentle up/down bob) ---------- */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        ...
        {/* Row: lower-mid (60–75%) */}
        <Cloud variant={1} className="absolute w-30 sm:w-40 text-secondary-100 dark:text-neutral-800/28 opacity-45 dark:opacity-18 animate-cloud-bob-8 top-[62%] left-[25%]" />
      ...
      {/* ---------- Lost cloud illustration (bottom of page) ---------- */}
