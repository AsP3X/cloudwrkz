...
const EMPTY_SEARCH_PARAMS: NonNullable<UserPermissionsListPageProps['searchParams']> = {};

export function UserPermissionsListPage({ users: initialUsers, searchParams = EMPTY_SEARCH_PARAMS }: UserPermissionsListPageProps) {
