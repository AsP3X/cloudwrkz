...
export const LoginForm = ({ initialError, disabled: initialDisabled = false }: LoginFormProps) => {
  ...
  const [showQrLogin, setShowQrLogin] = React.useState(false);
  ...
  const onSubmit = async (data: LoginInput) => {
    ...
    try {
      // Attach device metadata so sessions can be tied to a specific device/browser
  ...
  return (
    ...
    >
      ...
      {!showQrLogin ? (
        ...
        <div className="rounded-lg border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800/50">
          <QrLoginPanel
