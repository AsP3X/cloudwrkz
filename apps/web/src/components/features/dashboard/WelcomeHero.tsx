...
interface WelcomeHeroProps {
  /** Display name (e.g. user.name or email prefix) */
  name: string;
  /** Optional title under the greeting (e.g. "Agent Dashboard") */
  title?: string;
  /** Role badge: User, Agent, Admin, Moderator */
  role: "USER" | "AGENT" | "ADMIN" | "MODERATOR";
  /** Use server date; if false, greeting/date are client-friendly (e.g. for static export) */
