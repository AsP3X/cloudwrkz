...
const EMPTY_USERS: NonNullable<TaskFormProps['users']> = [];
const EMPTY_TICKETS: NonNullable<TaskFormProps['tickets']> = [];

export const TaskForm = ({ users = EMPTY_USERS, tickets = EMPTY_TICKETS, canAssign = false }: TaskFormProps) => {
