...
export const TicketAssignmentFields = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Assigned To */}
      <div>
        <label htmlFor="ticket-assigned-to" className="text-xs font-medium text-neutral-500 uppercase tracking-wide mb-1 block">
          Assigned To
        </label>
        <Select
      ...
      {/* Assigned To Group */}
      <div>
        <label htmlFor="ticket-assigned-to-group" className="text-xs font-medium text-neutral-500 uppercase tracking-wide mb-1 block">
          Assigned To Group
        </label>
        <Select
          id="ticket-assigned-to-group"
