...
const EMPTY_STOPPED_TIME_ENTRIES: NonNullable<TicketCommentsAndActivityProps['stoppedTimeEntries']> = [];

export const TicketCommentsAndActivity = ({
  ticket,
  userRole,
  stoppedTimeEntries = EMPTY_STOPPED_TIME_ENTRIES,
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {comment.mergedFromTicketNumber && (
                        <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700">
                          Merged from {comment.mergedFromTicketNumber}
                        </span>
                      )}
                    </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      ...
                      {entry.mergedFromTicketNumber && (
                        <span className="inline-block px-2 py-1 rounded-full text-xs font-medium bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700">
                          Merged from {entry.mergedFromTicketNumber}
                        </span>
                      )}
                    </div>
                    {entry.description && (
