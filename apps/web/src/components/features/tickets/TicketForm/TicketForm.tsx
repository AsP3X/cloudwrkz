...
const EMPTY_USERS: NonNullable<TicketFormProps['users']> = [];
const EMPTY_AGENTS: NonNullable<TicketFormProps['agents']> = [];
const EMPTY_GROUPS: NonNullable<TicketFormProps['groups']> = [];
