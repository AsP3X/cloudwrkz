...
export const TicketStatusPriorityFields = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Status */}
      <div>
        <label htmlFor="ticket-status" className="text-xs font-medium text-neutral-500 uppercase tracking-wide mb-1 block">
          Status
        </label>
        <Select
          id="ticket-status"
      ...
      {/* Priority */}
      <div>
        <label htmlFor="ticket-priority" className="text-xs font-medium text-neutral-500 uppercase tracking-wide mb-1 block">
          Priority
        </label>
        <Select
          id="ticket-priority"
