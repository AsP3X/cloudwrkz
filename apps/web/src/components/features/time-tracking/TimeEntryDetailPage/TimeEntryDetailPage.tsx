          ...
          <div className="bg-white dark:bg-neutral-900 rounded-xl shadow-soft-lg border border-neutral-200 dark:border-neutral-800 p-4 sm:p-6">
            ...
            {isEditing ? (
              ...
              <div className="space-y-4">
                ...
                {entry.location && (
                  <div>
                    <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Location</span>
                ...
                {entry.tags.length > 0 && (
                  <div>
                    <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Tags</span>
                ...
                {entry.ticket && (
                  <div>
                    <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Ticket</span>
                    <div className="mt-1">
                      <Link
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-xl shadow-soft-lg border border-neutral-200 dark:border-neutral-800 p-4 sm:p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Started</span>
                <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-400">{formatDate(entry.startedAt)}</p>
              </div>
              {entry.pausedAt && (
                <div>
                  <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Paused</span>
                  <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-400">{formatDate(entry.pausedAt)}</p>
                </div>
              )}
              {entry.lastResumedAt && (
                <div>
                  <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Last Resumed</span>
                  <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-400">{formatDate(entry.lastResumedAt)}</p>
                </div>
              )}
              {entry.stoppedAt && (
                <div>
                  <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Stopped</span>
                  <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-400">{formatDate(entry.stoppedAt)}</p>
                </div>
              )}
              {entry.completedAt && (
                <div>
                  <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Completed</span>
                  <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-400">{formatDate(entry.completedAt)}</p>
                </div>
              )}
              <div>
                <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Last Updated</span>
