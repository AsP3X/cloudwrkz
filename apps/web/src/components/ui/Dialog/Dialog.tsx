...
export const Dialog = React.forwardRef<HTMLDivElement, DialogProps>(
  ({ open, onOpenChange, children, title, description, infoIcon, headerIcon, headerRightContent, className, zIndex, hideHeaderBorder, ...props }, ref) => {
    ...
    const dialogContent = (
      <>
        ...
        <div
          role="presentation"
          className="fixed inset-0 flex items-center justify-center px-4 py-4 sm:px-6 sm:py-6 overflow-x-hidden sm:overflow-x-auto touch-none sm:touch-auto"
          style={{ 
            zIndex: zIndex || 50,
            touchAction: 'pan-y' 
          }}
          ...
          >
            ...
            {infoIcon && (
              ...
              {(title || description) && (
                <div
                  className={cn(
                    "px-4 sm:px-6 py-4 flex items-center justify-between gap-4",
                    !hideHeaderBorder && "border-b border-neutral-200 dark:border-neutral-800"
                  )}
                >
