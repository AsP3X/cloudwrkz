      ...
      editorProps: {
        ...
        attributes: {
          class: cn(
            ...
            // Code blocks are handled by custom node view, so we don't need prose-pre styling
    ...
    React.useEffect(() => {
      ...
      return () => {
        if (window.visualViewport) {
          ...
          window.visualViewport.removeEventListener("scroll", updateKeyboardHeight, { passive: true } as EventListenerOptions);
        }
