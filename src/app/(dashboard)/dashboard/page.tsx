...
async function AgentDashboard({ user }: { user: CurrentUser }) {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Section */}
      <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 p-6 sm:p-8 relative overflow-hidden">
        {/* Decorative gradient overlay */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-primary-100/30 to-secondary-100/30 rounded-full blur-3xl -mr-32 -mt-32" />
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-neutral-600 text-lg">
                Welcome back, <span className="font-semibold text-neutral-900">{user.name || user.email.split("@")[0]}</span>! Manage and track support tickets.
              </p>
            </div>
            <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary-100 to-primary-50 rounded-lg border border-primary-200/50 shadow-sm">
              <svg
      ...
      {ticketsEnabled && ticketStats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {/* Assigned Tickets */}
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 p-6 hover:shadow-soft-md transition-all duration-200 hover:scale-[1.02] relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-primary-100/20 rounded-full blur-2xl -mr-16 -mt-16 group-hover:bg-primary-200/30 transition-colors" />
            <div className="relative z-10">
              <div className="flex items-center justify-between">
                <div>
                ...
                <div className="w-12 h-12 bg-gradient-to-br from-primary-100 to-primary-50 rounded-lg flex items-center justify-center border border-primary-200/50 shadow-sm">
                  <svg
          ...
          {/* Unassigned Tickets */}
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 p-6 hover:shadow-soft-md transition-all duration-200 hover:scale-[1.02] relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-warning-100/20 rounded-full blur-2xl -mr-16 -mt-16 group-hover:bg-warning-200/30 transition-colors" />
            <div className="relative z-10">
              <div className="flex items-center justify-between">
                <div>
                ...
                <div className="w-12 h-12 bg-gradient-to-br from-warning-100 to-warning-50 rounded-lg flex items-center justify-center border border-warning-200/50 shadow-sm">
                  <svg
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 p-6 hover:shadow-soft-md transition-all duration-200 hover:scale-[1.02] relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between">
                ...
                <div className="w-12 h-12 bg-gradient-to-br from-success-100 to-success-50 rounded-lg flex items-center justify-center border border-success-200/50 shadow-sm">
                  <svg
          ...
          {/* Total Tickets */}
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 p-6 hover:shadow-soft-md transition-all duration-200 hover:scale-[1.02] relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-secondary-100/20 rounded-full blur-2xl -mr-16 -mt-16 group-hover:bg-secondary-200/30 transition-colors" />
            <div className="relative z-10">
              <div className="flex items-center justify-between">
                <div>
                ...
                <div className="w-12 h-12 bg-gradient-to-br from-secondary-100 to-secondary-50 rounded-lg flex items-center justify-center border border-secondary-200/50 shadow-sm">
                  <svg
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 p-6 sm:p-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-neutral-900 to-neutral-700 bg-clip-text text-transparent mb-6">Quick Actions</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {ticketsEnabled && (
              <>
                <Link
                  href="/dashboard/tickets?filter=assigned"
                  className="group p-5 border-2 border-neutral-200/50 rounded-xl hover:border-primary-300 hover:bg-gradient-to-br hover:from-primary-50 hover:to-primary-50/50 transition-all duration-200 text-left hover:shadow-md relative overflow-hidden"
                >
                  <div className="absolute top-0 right-0 w-24 h-24 bg-primary-100/0 group-hover:bg-primary-100/20 rounded-full blur-2xl -mr-12 -mt-12 transition-all" />
                  <div className="relative z-10">
                    ...
                    <h3 className="font-semibold text-neutral-900 mb-1 group-hover:text-primary-700 transition-colors">My Assigned Tickets</h3>
                ...
                >
                  <div className="absolute top-0 right-0 w-24 h-24 bg-warning-100/0 group-hover:bg-warning-100/20 rounded-full blur-2xl -mr-12 -mt-12 transition-all" />
                  <div className="relative z-10">
                    <div className="w-10 h-10 bg-warning-100 rounded-lg flex items-center justify-center mb-3 group-hover:bg-warning-200 transition-colors">
                      <svg className="w-5 h-5 text-warning-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <h3 className="font-semibold text-neutral-900 mb-1 group-hover:text-warning-700 transition-colors">Unassigned Tickets</h3>
                    <p className="text-sm text-neutral-600">Browse available tickets</p>
                  </div>
                </Link>
                <Link
                  href="/dashboard/tickets"
                  className="group p-5 border-2 border-neutral-200/50 rounded-xl hover:border-secondary-300 hover:bg-gradient-to-br hover:from-secondary-50 hover:to-secondary-50/50 transition-all duration-200 text-left hover:shadow-md relative overflow-hidden"
                >
                  <div className="absolute top-0 right-0 w-24 h-24 bg-secondary-100/0 group-hover:bg-secondary-100/20 rounded-full blur-2xl -mr-12 -mt-12 transition-all" />
                  <div className="relative z-10">
                    <div className="w-10 h-10 bg-secondary-100 rounded-lg flex items-center justify-center mb-3 group-hover:bg-secondary-200 transition-colors">
                    ...
                    <h3 className="font-semibold text-neutral-900 mb-1 group-hover:text-secondary-700 transition-colors">All Tickets</h3>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-semibold text-neutral-900 mb-1 group-hover:text-primary-700 transition-colors">View Profile</h3>
                <p className="text-sm text-neutral-600">Manage your profile settings</p>
              </div>
            </Link>
            <Link
              href="/dashboard/settings"
              className="group p-5 border-2 border-neutral-200/50 rounded-xl hover:border-neutral-300 hover:bg-gradient-to-br hover:from-neutral-50 hover:to-neutral-50/50 transition-all duration-200 text-left hover:shadow-md relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-24 h-24 bg-neutral-100/0 group-hover:bg-neutral-100/20 rounded-full blur-2xl -mr-12 -mt-12 transition-all" />
              <div className="relative z-10">
                ...
                <h3 className="font-semibold text-neutral-900 mb-1 group-hover:text-neutral-700 transition-colors">Settings</h3>
      ...
      {ticketsEnabled && ticketStats && ticketStats.assigned > 0 && (
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 p-6 sm:p-8 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-primary-100/10 rounded-full blur-3xl -mr-32 -mt-32" />
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-neutral-900 to-neutral-700 bg-clip-text text-transparent">My Assigned Tickets</h2>
              <Link
                href="/dashboard/tickets?filter=assigned"
            ...
            <div className="space-y-3">
              {unresolvedAssigned.slice(0, 5).map((ticket) => (
                <Link
                  ...
                  className="block p-4 border border-neutral-200/50 rounded-xl hover:border-primary-300 hover:bg-gradient-to-r hover:from-primary-50/50 hover:to-transparent transition-all duration-200 hover:shadow-sm group"
                >
      ...
      {ticketsEnabled && ticketStats && ticketStats.unassigned > 0 && (
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 p-6 sm:p-8 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-warning-100/10 rounded-full blur-3xl -mr-32 -mt-32" />
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-neutral-900 to-neutral-700 bg-clip-text text-transparent">Unassigned Tickets</h2>
              <Link
                href="/dashboard/tickets?filter=unassigned"
                className="text-sm text-primary-600 hover:text-primary-700 font-medium flex items-center gap-1 group"
              >
            ...
            <div className="space-y-3">
              {unresolvedUnassigned.slice(0, 5).map((ticket) => (
                <Link
                  key={ticket.id}
                  href={`/dashboard/tickets/${ticket.id}`}
                  className="block p-4 border border-neutral-200/50 rounded-xl hover:border-warning-300 hover:bg-gradient-to-r hover:from-warning-50/50 hover:to-transparent transition-all duration-200 hover:shadow-sm group"
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
    ...
    <div className="space-y-6">
            ...
            {ticketsEnabled && (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-semibold text-neutral-900 mb-1 group-hover:text-primary-700 transition-colors">Create Ticket</h3>
      ...
      {ticketsEnabled && ticketStats && ticketStats.total > 0 && (
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 p-6 sm:p-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-neutral-900 to-neutral-700 bg-clip-text text-transparent">Recent Unresolved Tickets</h2>
              <Link
                href="/dashboard/tickets"
                className="text-sm text-primary-600 hover:text-primary-700 font-medium flex items-center gap-1 group"
              >
