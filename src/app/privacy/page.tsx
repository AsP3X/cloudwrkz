      ...
      <main className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 pt-16 pb-20">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Content Card */}
            <div className="bg-white rounded-xl shadow-soft-lg border border-neutral-200 p-8 sm:p-12">
              <div className="prose prose-neutral max-w-none">
                ...
                <section className="mb-8">
                  ...
                  <div className="mt-4 p-4 bg-neutral-50 rounded-lg">
                    ...
                    <p className="text-neutral-700 mt-2">
                      <strong>Website:</strong> <a href="https://www.bfdi.bund.de" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700">www.bfdi.bund.de</a>
                    </p>
                    <p className="text-neutral-700 mt-2">
