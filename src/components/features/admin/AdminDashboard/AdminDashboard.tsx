import { getAdminStats } from "@/server/actions/admin/stats";
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-lg">
                Welcome back, <span className="font-semibold text-neutral-900 dark:text-neutral-100">{user.name || user.email.split("@")[0]}</span>! Manage your system.
              </p>
            </div>
            <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary-100 to-primary-50 dark:from-primary-900 dark:to-primary-950 rounded-lg border border-primary-200/50 dark:border-primary-800/50 shadow-sm">
              ...
              <span className="text-sm font-semibold text-primary-700 dark:text-primary-300">Admin</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent mt-2">{stats.totalUsers}</p>
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold bg-gradient-to-r from-secondary-600 to-secondary-700 bg-clip-text text-transparent mt-2">{stats.totalTickets}</p>
                <p className="text-xs text-neutral-500 dark:text-neutral-500 mt-1">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold bg-gradient-to-r from-success-600 to-success-700 bg-clip-text text-transparent mt-2">{stats.activeSessions}</p>
                <p className="text-xs text-neutral-500 dark:text-neutral-500 mt-1">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold bg-gradient-to-r from-warning-600 to-warning-700 bg-clip-text text-transparent mt-2">{stats.enabledModules}</p>
                <p className="text-xs text-neutral-500 dark:text-neutral-500 mt-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 dark:border-neutral-800/50 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mt-2">{stats.totalGroups}</p>
            </div>
        ...
        <div className="bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 dark:border-neutral-800/50 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-neutral-600 dark:text-neutral-400">Recent Registrations</p>
              <p className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mt-2">{stats.recentRegistrations}</p>
              <p className="text-xs text-neutral-500 dark:text-neutral-500 mt-1">Last 7 days</p>
            </div>
            <div className="w-10 h-10 bg-neutral-100 dark:bg-neutral-800 rounded-lg flex items-center justify-center">
              <svg className="w-5 h-5 text-neutral-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm rounded-xl shadow-soft-lg border border-neutral-200/50 dark:border-neutral-800/50 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-neutral-600 dark:text-neutral-400">Recent Tickets</p>
              <p className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mt-2">{stats.recentTickets}</p>
              <p className="text-xs text-neutral-500 dark:text-neutral-500 mt-1">Last 7 days</p>
            </div>
            <div className="w-10 h-10 bg-neutral-100 dark:bg-neutral-800 rounded-lg flex items-center justify-center">
              <svg className="w-5 h-5 text-neutral-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-primary-700 dark:group-hover:text-primary-300 transition-colors">Manage Users</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">View and manage all users</p>
              </div>
            </Link>
            <Link
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-secondary-700 dark:group-hover:text-secondary-300 transition-colors">Manage Modules</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Enable or disable modules</p>
              </div>
            </Link>
            <Link
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-warning-700 dark:group-hover:text-warning-200 transition-colors">Manage Groups</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Manage agent groups</p>
              </div>
            </Link>
            <Link
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1 group-hover:text-neutral-700 dark:group-hover:text-neutral-200 transition-colors">System Settings</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">System configuration</p>
              </div>
            </Link>
          </div>
        </div>
