  ...
  return (
    <>
      ...
      >
        ...
        <span className="text-sm text-neutral-500 dark:text-neutral-400">Search...</span>
        <div className="ml-auto flex items-center gap-1 text-xs text-neutral-400 dark:text-neutral-600">
