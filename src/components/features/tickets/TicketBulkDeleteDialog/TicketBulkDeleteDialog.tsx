...
export const TicketBulkDeleteDialog = ({
  open,
  onOpenChange,
  onConfirm,
  selectedCount,
  ...
  return (
    <Dialog
      ...
      description="This action cannot be undone. All selected tickets will be permanently deleted."
    >
      <div className="p-6 space-y-6">
        ...
        <div className="text-center space-y-2">
          <p className="text-sm text-neutral-600 dark:text-neutral-400">
            Are you sure you want to delete <span className="font-semibold text-neutral-900 dark:text-neutral-100">{selectedCount}</span> ticket{selectedCount !== 1 ? "s" : ""}?
          </p>
          <p className="text-xs text-neutral-500 dark:text-neutral-500">
            This will permanently remove all selected tickets and cannot be undone.
          </p>
        </div>
