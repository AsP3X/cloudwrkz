...
export function DatabaseWarning({ isServerUnreachable = false, error }: DatabaseWarningProps) {
  // Prioritize server unreachable message over database connection error
            ...
            <p className="text-sm text-red-700 dark:text-red-300">
              ...
              {!isServerUnreachable && !error && (
                <>
                  ...
                  <Link
                    href="/health"
                    className="underline font-medium hover:text-red-900 dark:hover:text-red-100 transition-colors"
                  >
                    health status page
                  </Link>{" "}
